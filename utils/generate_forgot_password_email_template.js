export const generate_forgot_password_email_template = (reset_password_url) => {
    return `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #ddd; border-radius: 8px; background-color: #000; color: #fff;">
          ...
          <p style="font-size: 16px; color: #fff; word-wrap: break-word;">${reset_password_url}</p>
          <footer style="margin-top: 20px; text-align: center; font-size: 14px; color: #666;">
            <p>Thank you,<br>ShopMate Team</p>
